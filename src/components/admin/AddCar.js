            ...
            >
              <Form.Item label="ทะเบียนรถ">
                ...
                >
                  <Input
                    ...
                    value={inputCarLicenseText}
                    onChange={handleChangeCarLicenseText}
                  />
                </Form.Item>
                ...
                >
                  <Input
                    className="inline-flex w-auto"
                    value={inputCarLicenseNum}
                    onChange={handleChangeCarLicenseNum}
                  />
                </Form.Item>
              </Form.Item>
              <Form.Item
              ...
              >
                <Select
                  ...
                  onChange={handleChangeCarProvince}
                  value={selectedCarProvince}
                >
              ...
              <Form.Item label="เริ่มเช่า">
                <Form.Item
                  ...
                  noStyle
                  rules={[
                    { required: true, message: "กรุณาป้อนเดือนที่เริ่มเช่า" },
                  ]}
                >
                  <Select
                    style={{ width: 180 }}
                ...
                <Form.Item
                  ...
                  noStyle
                  rules={[
                    { required: true, message: "กรุณาป้อนปีที่เริ่มเช่า" },
                  ]}
                >
                  <Select
                    style={{ width: 180 }}
              ...
              <Form.Item label="รายละเอียดเพิ่มเติม" name={"carDetail"}>
                <Input.TextArea
                  ...
                  value={inputCarDetail}
                  onChange={handleChangeCarDetail}
                />
              </Form.Item>
                ...
                >
                  ...
                  >
                    ...
                    <p className="ant-upload-text">
                      "คลิก" หรือ "ลาก" รูปภาพวางในช่องอัปโหลด
                    </p>
